...
/**
 * Servlet JSP 向けの単一レイヤーアーキテクチャーコントローラーのサンプルです。
 * <ul>
 * <li>シンプルな単一レイヤー: 複数レイヤーでの開発や処理の分散が不要な Servlet 用です。
 ...
 * <li>自動 CSRF チェック: Cookie ベースのため、JSP や各サーブレット側では考慮不要です。
 * </ul>
...
public class SingleTierController extends HttpFilter {
	...
	protected void doFilter(HttpServletRequest req, HttpServletResponse res, FilterChain chain) {
		...
		session.setAttribute(CSRF_NAME, newCsrf); // Servlet API 5.1 未満 Cookie は SameSite 未対応のため直書き
